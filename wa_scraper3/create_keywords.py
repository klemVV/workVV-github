...
# --- CONFIG ---
OUT_DIR = Path("/Users/klemanroy/Github/workVV-github/wa_scraper3/search_keywords")
...
def main():
    ...
    for first_char in CHARS:
        ...
        with out_path.open("w", encoding="utf-8") as f:
            for mid1, mid2, mid3, last in product(CHARS, repeat=4):
                keyword = f"{first_char}{mid1}{mid2}{mid3}{last}"
                f.write(keyword + "\n")
                total += 1
